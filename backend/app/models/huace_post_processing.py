...
class HuacePostProcessing(Base):
    __tablename__ = "huace_post_processing"

    id = Column(Integer, primary_key=True, autoincrement=True)
    code = Column(String(40), nullable=False, unique=True)
    name = Column(String(50), nullable=False)
    proc_group = Column(String(30), nullable=False)
    price_type = Column(String(20), nullable=False, default="per_area")
